...
class HistorySerializer(serializers.ModelSerializer):
	'''
	Receipt serializer for generated receipts
	'''
	...
	def is_valid(self, raise_Exception=False):
		...
		was done basically to perform custom validation on updated
		receipt.There's no need for extreme serialization of created
		receipts, as this is does not need user input for generation
		"""
