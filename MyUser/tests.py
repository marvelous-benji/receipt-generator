...
class Authentication_Test(APITestCase):
    ...
    def test_signup(self):
        ...
        data0 = {'email':'test@test.com',
                'fullname':'test0', 
                'password':'1234567890',
                'business_name':'test sales'}
    ...
    def test_signin(self):
        ...
        CustomUser.objects.create_user('bj@gmail.com',
                                        'bj',password='pass_123',
                                        business_name='benji sales')
        data0 = {'email':'bj@gmail.com',
                'password':'pass_123'}
                
        data1 = {'email':'bj@gmail.com',
                'password':'pas_123'}
